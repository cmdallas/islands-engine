defmodule IslandsEngine.Rules do
  @moduledoc """
    ...
    Rules is a state machine comprised of a single function and
  ...
  @doc """
    ## Examples
      ...
      iex> {:ok, rules} = IslandsEngine.Rules.check(rules, :add_player)
      iex> rules.state
      :players_set
  """
  def check(%{state: :initialized} = rules, :add_player), do:
