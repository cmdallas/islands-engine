defmodule IslandsEngine.Board do
  @moduledoc """
    Players will be able to move their islands around the board until they declare them set.
  """
  ...
  defp overlaps_existing_island?(board, new_key, new_island) do
    Enum.any?(
      board,
      fn {key, island} -> key != new_key and Island.overlaps?(island, new_island)
    end)
  end
